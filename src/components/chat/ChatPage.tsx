...
import { Folder, FolderOpen, Loader2, MessageSquare, Send, Square } from "lucide-react";
...
export function ChatPage() {
  ...
  const chooseDirectory = async () => {
    ...
    try {
      const response = await fetch("/api/pi/chat/select-directory", { method: "POST" });
