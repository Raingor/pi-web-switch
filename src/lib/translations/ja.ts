...
const ja: Record<string, string> = {
  ...
  "providers_models.manual_key_switch_note": "「使用中」にしたキーだけを手動で使います。自動切り替えは無効です。",
  "providers_models.auto_failover": "キー自動切替（429 / 残高不足）",
  "providers_models.auto_failover_desc": "現在のキーがレート制限や残高不足になったら、次のキーで自動リトライ（ターミナルと Web Chat の両方で有効）",
  "providers_models.auto_failover_ineligible": "カスタムプロバイダー・キー2個以上・Base URL と API タイプの入力が必要です（!command キーは非対応）",
  "providers_models.auto_failover_note": "pi-web-switch 拡張パッケージ（pi install）が必要です。残高不足で一時停止されたキーは、ここまたは /pi-key-reset で手動復元するまで停止したままになります。レート制限のクールダウンは約60秒。",
  "providers_models.key_paused_balance": "停止中・残高不足",
  "providers_models.key_cooldown": "クールダウン {0}秒",
  "providers_models.key_reset_health": "このキーを復元（停止/クールダウン状態を解除）",
  ...
  "providers_models.id_preview": "ID “{0}” として保存されます",
    ...
    "providers_models.import_desc": "名前、baseurl、key または key-1/key-2、modelid を含むテキストを貼り付けると、プロバイダー、複数のキー、モデルを自動認識します。インポートしたモデルは自動的に有効化されます。",
    "providers_models.import_placeholder": "tokenrouter baseurl: https://api.example.com/v1\nkey-1: sk-xxxx\nkey-2: sk-yyyy\nmodelid: vendor/model-name",
    "providers_models.import_keys": "API キープール",
    "providers_models.import_key_count": "{0} キー",
    "providers_models.import_keys_placeholder": "key-1: sk-...\nkey-2: sk-...",
    "providers_models.import_keys_hint": "1 行につき 1 キー。key-1、api-key-2、token-3 などのラベルに対応します。最初のキーが有効になります。",
  ...
  "jev.title": "Jev 構造化評価",
  "jev.subtitle": "TypeSafe AI でテキストまたは JSON 状態を評価し、構造化された判断結果を返します。",
  "jev.docs": "ドキュメント",
  "jev.provider": "TypeSafe AI プロバイダー",
  "jev.provider_desc": "Jev はチャット補完モデルではなく、構造化された意思決定モデルです。キーはローカルサーバーにのみ保存されます。",
  "jev.configured": "設定済み",
  "jev.api_key": "API キー",
  "jev.model": "モデル",
  "jev.save": "設定を保存",
  "jev.save_failed": "設定の保存に失敗しました",
  "jev.saved": "保存しました",
  "jev.state": "評価対象の状態",
  "jev.state_hint": "Jev に評価させるテキスト、レコード、または JSON 状態を入力します。",
  "jev.state_placeholder": "テキストまたは JSON 状態を貼り付け...",
  "jev.parse_json": "JSON として解析",
  "jev.questions": "質問定義",
  "jev.questions_hint": "Noul、Choice、Score の JSON 質問マップを入力します。",
  "jev.reset": "サンプルに戻す",
  "jev.evaluate": "Jev で評価",
  "jev.evaluating": "評価中...",
  "jev.key_required": "評価する前に TypeSafe API キーを保存してください。",
  "jev.invalid_questions": "質問は有効な JSON オブジェクトである必要があります。",
  "jev.invalid_state": "状態は有効な JSON である必要があります。",
  "jev.evaluate_failed": "評価に失敗しました",
  "jev.result": "評価結果",
  ...
  "changelog.0_9_4_1": "Pi 使用量、ローカル ChatGPT/Codex 使用量、Codex 公式利用枠を表示する軽量な Swift/AppKit Native macOS メニューバーアプリを追加しました。",
  "changelog.0_9_4_2": "設定ページから ~/.pi/agent/settings.json を通じて Native メニューバー機能の表示・非表示を切り替えられます。",
  "changelog.0_9_4_3": "Native 使用量パネルのレイアウトを改善し、ビルドと起動コマンドを文書化しました。",
  "changelog.0_9_2_1": "修正：モデル編集やプロバイダーの追加削除で、無効化済みのカスタムプロバイダーが消える不具合。",
  "changelog.0_9_2_2": "プロバイダーインポートがキープール対応：key-1 / key-2 のような番号付きラベルが上書きされなくなりました。",
  "changelog.0_9_2_3": "ドキュメント：姐妹プロジェクト pi-desktop を追加し、古い Electron 記述を整理。",
  "changelog.0_9_1_1": "Pi CLI 設定ページを追加：6 セクション 30 項目、モデル別の思考レベル設定を含む。",
  "changelog.0_9_1_2": "Skills ページとコマンドページを追加。ローカルのスキルと Pi 内蔵スラッシュコマンドを一覧表示。",
  "changelog.0_9_1_3": "レイアウトを単一形式にし、チャットをナビ項目へ；ネストされた設定の保存で同グループの他の値が消えなくなりました。",
  "changelog.0_9_0_1": "新指 Codex 風のローカルチャットワークスペース：ストリーミング応答、思考/ツール工程の折り畳み表示。",
  "changelog.0_9_0_2": "チャット：モデルと思考レベル選択、編集再送、実行停止、セッション使用量パネル。",
  "changelog.0_9_0_3": "サイドバーをプロジェクト別セッションリスト化（新規/削除/一括ゴミ箱）。",
  "changelog.0_9_0_4": "ベーシック/チャットの UI モード切替、チャットのネイティブフォルダ選択。",
  "changelog.0_9_0_5": "プロバイダーの無効化/有効化、無効中も設定を保持。",
  ...
  "dashboard.subscription_usage": "サブスクリプション利用量",
  "dashboard.not_billed": "個別請求なし",
  "dashboard.load_error": "使用量データを読み込めません",
  "dashboard.load_error_hint": "ローカルの使用量リーダーが応答しません。サービスを確認して再試行してください。",
  "dashboard.retry": "再試行",
  ...
  "dashboard.cost_label_usd": "コスト ($)",
  "dashboard.cost_label_cny": "コスト (¥)",
  ...
  "dashboard.model_mix": "モデル分布",
  "dashboard.detailed_analysis": "詳細分析",
  "dashboard.detailed_analysis_hint": "運用指標、トークン構成、ランキング",
  "dashboard.raw_data": "生データ",
  "dashboard.raw_data_hint": "リクエストログと集計統計",
  "dashboard.monthly_view": "月別表示",
  ...
  "models.save": "保存",
  "models.cancel": "キャンセル",
  "models.select_all": "すべて選択",
  "models.deselect_all": "選択解除",
  "models.batch_delete": "一括削除",
  "models.batch_delete_count": "削除 ({0})",
  "models.batch_delete_confirm": "{0} 個の選択モデルを削除してもよろしいですか？この操作は元に戻せません。",
  ...
  "compat.desc": "迷ったら推奨値のままにしてください。対応するエラーが出たときだけ変更します。",
  "compat.helper_title": "互換性ヘルパー",
  "compat.helper_desc": "モデルテストで既知のエラーを検出すると、ここにワンクリックの修正案を表示します。推奨値にも戻せます。",
  "compat.helper_defaults": "推奨値に戻す",
  "compat.helper_detected": "互換性エラーの可能性を検出",
  "compat.helper_apply": "修正案を適用",
  ...
  "compat.supports_developer_role_desc": "未設定時は pi が developer を既定で使用します。API が対応している場合だけオンのままにし、400 developer is not one of [...] または unsupported role: developer が出たらオフにします。",
  "compat.developer_action_off": "developer をオフ（system）",
  "compat.developer_action_on": "developer をオン",
  "compat.supports_finish_reason": "finish_reason を必須にする",
  "compat.supports_finish_reason_desc": "既定はオンで、ストリームに finish_reason を要求します。Stream ended without finish_reason が出たらオフにし、finish_reason is required が出たらオンにします。",
  "compat.finish_action_off": "厳密チェックをオフ",
  "compat.finish_action_on": "厳密チェックをオン",
...
"sessions.no_search_results": "検索条件に一致するセッションが見つかりません",
  ...
  "settings.show_native": "Native macOS メニューバーを表示",
  "settings.show_native_desc": "macOS メニューバーの Pi 用量と ChatGPT 用量の表示を個別に設定します。旧 showNative 設定は既定値として互換利用されます。",
  "settings.show_pi_native": "Pi 使用量メニューバーを表示",
  "settings.show_chatgpt_native": "ChatGPT 使用量メニューバーを表示",
  "native.title": "Native macOS",
  "native.subtitle": "ウェブパネルを開かずに Pi と ChatGPT の使用量を確認できる軽量なネイティブアプリです。",
  "native.app_title": "Pi と ChatGPT の使用量メニューバー",
  "native.app_desc": "このプロジェクトから Pi 用と ChatGPT 用の Swift/AppKit ネイティブメニューバーアプリを個別にビルドして起動できます。使用量はバックグラウンドで更新され、ウェブパネルとは独立して動作します。",
  "native.requirement": "macOS と Swift Command Line Tools が必要です。",
  "native.features_title": "機能",
  "native.feature_usage": "Pi と ChatGPT の Token、コスト、リクエスト数、キャッシュ統計",
  "native.feature_quota": "ChatGPT / Codex 公式クォータの概要",
  "native.feature_background": "メニューバーの操作を妨げないバックグラウンド更新",
  "native.feature_lightweight": "Electron や WebView を使わない Swift/AppKit 実装",
  "native.source": "Native ソースを見る",
