...
"sessions.no_search_results": "検索条件に一致するセッションが見つかりません",
  ...
  "settings.show_native_desc": "macOS のメニューバーに Native 使用量機能を表示するかどうかを設定します。",
  "native.title": "Native macOS",
  "native.subtitle": "ウェブパネルを開かずに Pi の使用量を確認できる軽量なネイティブアプリです。",
  "native.app_title": "Pi 使用量メニューバー",
  "native.app_desc": "このプロジェクトから Swift/AppKit のネイティブメニューバーアプリをビルドして起動できます。使用量はバックグラウンドで更新され、ウェブパネルとは独立して動作します。",
  "native.requirement": "macOS と Swift Command Line Tools が必要です。",
  "native.features_title": "機能",
  "native.feature_usage": "Pi の Token、コスト、リクエスト数、キャッシュ統計",
