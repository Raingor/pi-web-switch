...
"sessions.no_search_results": "No sessions match your search",
  ...
  "settings.show_native_desc": "Controls whether the Native usage menu bar feature appears in the macOS menu bar.",
  "native.title": "Native macOS",
  "native.subtitle": "A lightweight native menu bar app for viewing Pi usage without opening the web panel.",
  "native.app_title": "Pi Usage Menu Bar",
  "native.app_desc": "Build and launch the native Swift/AppKit menu bar app from this project. It refreshes usage data in the background and keeps the web panel independent.",
  "native.requirement": "Requires macOS and the Swift Command Line Tools.",
  "native.features_title": "Features",
  "native.feature_usage": "Pi token, cost, request, and cache statistics",
