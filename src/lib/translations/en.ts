...
const en: Record<string, string> = {
  ...
  "chat.continue": "Continue in Chat",
  ...
  "providers_models.manual_key_switch_note": "Keys are used only from the one you mark In use; automatic switching is disabled.",
  "providers_models.auto_failover": "Auto key failover (429 / out of balance)",
  "providers_models.auto_failover_desc": "When the current key hits a rate limit or runs out of balance, automatically retry with the next key (terminal and Web Chat)",
  "providers_models.auto_failover_ineligible": "Requires a custom provider with ≥2 keys, a Base URL and API type (!command keys are not supported)",
  "providers_models.auto_failover_note": "Requires the pi-web-switch extension package (pi install). Keys paused for insufficient balance stay paused until manually restored here or via /pi-key-reset; rate-limit cooldown is ~60s.",
  "providers_models.key_paused_balance": "Paused · out of balance",
  "providers_models.key_cooldown": "Cooldown {0}s",
  "providers_models.key_reset_health": "Restore this key (clear paused/cooldown state)",
  ...
  "providers_models.id_preview": "Will be saved as ID “{0}”",
    ...
    "providers_models.import_desc": "Paste name, baseurl, key or key-1/key-2, and modelid. The provider, multiple keys, and models are detected automatically; imported models are enabled by default.",
    "providers_models.import_placeholder": "tokenrouter baseurl: https://api.example.com/v1\nkey-1: sk-xxxx\nkey-2: sk-yyyy\nmodelid: vendor/model-name",
    "providers_models.import_keys": "API key pool",
    "providers_models.import_key_count": "{0} keys",
    "providers_models.import_keys_placeholder": "key-1: sk-...\nkey-2: sk-...",
    "providers_models.import_keys_hint": "One key per line. Labels such as key-1, api-key-2, and token-3 are supported. The first key becomes active.",
  ...
  "nav.jev": "Jev Evaluation",
  "nav.native": "Native macOS",
  "jev.title": "Jev Structured Evaluation",
  "jev.subtitle": "Evaluate text or JSON state with TypeSafe AI and receive typed decisions.",
  "jev.docs": "Documentation",
  "jev.provider": "TypeSafe AI Provider",
  "jev.provider_desc": "Jev is a structured-decision model, not a chat-completions model. The key is stored locally on the server.",
  "jev.configured": "Configured",
  "jev.api_key": "API key",
  "jev.model": "Model",
  "jev.save": "Save configuration",
  "jev.save_failed": "Failed to save configuration",
  "jev.saved": "Saved",
  "jev.state": "State",
  "jev.state_hint": "The text, record, or JSON state Jev should evaluate.",
  "jev.state_placeholder": "Paste text or JSON state...",
  "jev.parse_json": "Parse as JSON",
  "jev.questions": "Questions",
  "jev.questions_hint": "Enter a JSON map of Noul, Choice, and Score questions.",
  "jev.reset": "Reset example",
  "jev.evaluate": "Evaluate with Jev",
  "jev.evaluating": "Evaluating...",
  "jev.key_required": "Save a TypeSafe API key before evaluating.",
  "jev.invalid_questions": "Questions must be valid JSON object.",
  "jev.invalid_state": "State must be valid JSON.",
  "jev.evaluate_failed": "Evaluation failed",
  "jev.result": "Evaluation result",
  ...
  "app.version": "pi-switch v0.9.4",
  "changelog.button": "Changelog",
  "changelog.title": "What's New",
  "changelog.0_9_4_1": "Added a lightweight Swift/AppKit Native macOS menu bar app for Pi usage, local ChatGPT/Codex usage, and official Codex quota.",
  "changelog.0_9_4_2": "The web Settings page can show or hide the Native menu bar feature through ~/.pi/agent/settings.json.",
  "changelog.0_9_4_3": "Improved the Native usage panel layout and documented its build and launch commands.",
  "changelog.0_9_2_1": "Fixed: editing models or adding/removing providers could silently delete disabled custom providers.",
  "changelog.0_9_2_2": "Provider import now builds a key pool — numbered labels like key-1 / key-2 no longer overwrite each other.",
  "changelog.0_9_2_3": "Docs: added the sister project pi-desktop and removed the stale Electron sections.",
  "changelog.0_9_1_1": "New Pi CLI settings page: 30 options across 6 sections, including per-model thinking levels.",
  "changelog.0_9_1_2": "New Skills and Commands pages listing local skill packs and Pi's built-in slash commands.",
  "changelog.0_9_1_3": "Single layout with chat as a nav item; nested settings writes no longer clobber sibling fields.",
  "changelog.0_9_0_1": "New Codex-style local chat workspace: streaming replies, collapsible thinking/tool steps.",
  "changelog.0_9_0_2": "Chat: model & thinking-level pickers, edit-and-resend, stop run, session usage panel.",
  "changelog.0_9_0_3": "Sidebar becomes a session list grouped by project, with new/delete/batch trash.",
  "changelog.0_9_0_4": "Basic/Chat UI mode switching; native folder picker for the chat workspace.",
  "changelog.0_9_0_5": "Providers can be disabled and re-enabled; config is kept while disabled.",
  ...
  "dashboard.source_all": "All sources",
  ...
  "dashboard.subscription_usage": "Subscription usage",
  "dashboard.not_billed": "Not billed separately",
  "dashboard.load_error": "Unable to load usage data",
  "dashboard.load_error_hint": "The local usage reader did not respond. Check the service and try again.",
  ...
  "dashboard.cost_label_usd": "Cost ($)",
  "dashboard.cost_label_cny": "Cost (¥)",
  ...
  "dashboard.model_mix": "Model Distribution",
  "dashboard.detailed_analysis": "Detailed analysis",
  "dashboard.detailed_analysis_hint": "Operational metrics, composition and rankings",
  "dashboard.raw_data": "Raw data",
  "dashboard.raw_data_hint": "Request log and grouped statistics",
  "dashboard.monthly_view": "monthly view",
  ...
  "models.select_all": "Select All",
  "models.deselect_all": "Deselect All",
  "models.batch_delete": "Batch Delete",
  "models.batch_delete_count": "Delete ({0})",
  "models.batch_delete_confirm": "Delete {0} selected models? This cannot be undone.",
  ...
  "compat.desc": "Keep the recommended values unless the matching error appears.",
  "compat.helper_title": "Compatibility helper",
  "compat.helper_desc": "After a model test finds a known error, this panel offers a one-click fix. You can also restore the recommended values.",
  "compat.helper_defaults": "Restore defaults",
  "compat.helper_detected": "Possible compatibility error detected",
  "compat.helper_apply": "Apply suggestion",
  "compat.developer_error": "400 developer is not one of [...] / unsupported role: developer",
  "compat.finish_error": "Stream ended without finish_reason",
  "compat.supports_developer_role": "Send system prompt as 'developer' role",
  "compat.supports_developer_role_desc": "When unset, pi uses developer by default. Keep it on only when the API supports it; turn it off for 400 developer is not one of [...] or unsupported role: developer.",
  "compat.developer_action_off": "Use system (turn off)",
  "compat.developer_action_on": "Turn on developer",
  "compat.supports_finish_reason": "Require finish_reason in the stream",
  "compat.supports_finish_reason_desc": "On by default: require finish_reason in the stream. Turn it off for Stream ended without finish_reason; turn it on for finish_reason is required.",
  "compat.finish_action_off": "Turn off strict check",
  "compat.finish_action_on": "Turn on strict check",
...
"sessions.no_search_results": "No sessions match your search",
  ...
  "settings.show_native": "Show Native macOS menu bar",
  "settings.show_native_desc": "Controls the Pi and ChatGPT usage menu bars separately. The legacy showNative setting is still used as the default for compatibility.",
  "settings.show_pi_native": "Show Pi usage menu bar",
  "settings.show_chatgpt_native": "Show ChatGPT usage menu bar",
  "native.title": "Native macOS",
  "native.subtitle": "Lightweight native menu bar apps for viewing Pi and ChatGPT usage without opening the web panel.",
  "native.app_title": "Pi & ChatGPT Usage Menu Bars",
  "native.app_desc": "Build and launch separate Swift/AppKit menu bar apps for Pi and ChatGPT usage. They refresh data in the background and keep the web panel independent.",
  "native.requirement": "Requires macOS and the Swift Command Line Tools.",
  "native.features_title": "Features",
  "native.feature_usage": "Pi and ChatGPT token, cost, request, and cache statistics",
  "native.feature_quota": "ChatGPT / Codex official quota overview",
  "native.feature_background": "Background refresh without blocking the menu bar",
  "native.feature_lightweight": "Native Swift/AppKit implementation, no Electron or WebView",
  "native.source": "View Native source",
