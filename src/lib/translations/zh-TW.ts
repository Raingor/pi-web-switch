...
"sessions.no_search_results": "沒有找到符合的會話",
  ...
  "settings.show_native_desc": "控制 macOS 右上角 Native 用量選單列功能是否顯示。",
  "native.title": "Native 原生 macOS",
  "native.subtitle": "無需開啟網頁面板，即可在 macOS 選單列查看 Pi 用量的輕量原生應用程式。",
  "native.app_title": "Pi 用量選單列",
  "native.app_desc": "從本專案建置並啟動 Swift/AppKit 原生選單列應用程式。它會在背景更新用量資料，不影響網頁面板運作。",
  "native.requirement": "需要 macOS 與 Swift Command Line Tools。",
  "native.features_title": "功能",
  "native.feature_usage": "Pi Token、成本、請求數與快取統計",
