...
"sessions.no_search_results": "没有找到匹配的会话",
  ...
  "settings.show_native_desc": "控制 macOS 右上角 Native 用量菜单栏功能是否显示。",
  "native.title": "Native 原生 macOS",
  "native.subtitle": "无需打开网页面板，即可在 macOS 菜单栏查看 Pi 用量的轻量原生应用。",
  "native.app_title": "Pi 用量菜单栏",
  "native.app_desc": "从本项目构建并启动 Swift/AppKit 原生菜单栏应用。它会在后台刷新用量数据，不影响网页面板运行。",
  "native.requirement": "需要 macOS 和 Swift Command Line Tools。",
  "native.features_title": "功能",
  "native.feature_usage": "Pi Token、成本、请求数和缓存统计",
